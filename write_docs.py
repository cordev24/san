...
1. **Implementar notificaciones automáticas:** Integrar correo electrónico o WhatsApp Business API para alertar sobre cuotas próximas a vencer, pagos aprobados o rechazados y las fechas en las que el usuario es notificado.
...
with open(r"C:\Users\Dell\Documents\san\leivis-pg2.md", "w", encoding="utf-8") as f:
    f.write(content)
